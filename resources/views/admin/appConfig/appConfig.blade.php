...
@section('content')
    <div class="mainbar">
      ...
      <!-- Page heading -->
      <div class="page-head">
        <h2 class="pull-left"><i class="icon-home"></i> App Configuration</h2>
                    ...
                    <ul class="chats">
                      ...
                      <li class="by-me">
                        ...
                        <div class="avatar pull-left">
                          <img src="public/admin/img/user.jpg" alt=""/>
                        </div>
              ...
              <div class="widget">
                ...
                <div class="widget-content referrer">
                  ...
                  <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                      <td><img src="public/admin/img/icons/chrome.png" alt="" />
                      <td>Google Chrome</td>
                      <td>3,005</td>
                    </tr> 
                    <tr>
                      <td><img src="public/admin/img/icons/firefox.png" alt="" />
                      <td>Mozilla Firefox</td>
                      <td>2,505</td>
                    </tr> 
                    <tr>
                      <td><img src="public/admin/img/icons/ie.png" alt="" />
                      <td>Internet Explorer</td>
                      <td>1,405</td>
                    </tr> 
                    <tr>
                      <td><img src="public/admin/img/icons/opera.png" alt="" />
                      <td>Opera</td>
                      <td>4,005</td>
                    </tr> 
                    <tr>
                      <td><img src="public/admin/img/icons/safari.png" alt="" />
                      <td>Safari</td>
                      <td>505</td>
                    </tr>                                                                    
                  </table>
