                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <input type="hidden" name="tagId" value="{{ $taskData->id }}" id="taskId">
                                        <div class="form-group">
                                            <label>Task Title</label>
                                            <input class="form-control" placeholder='Task Title Here' id="taskTitle" value="{{ $taskData->taskTitle }}">
                                        </div>
                                        <div class="form-group">
                                            <label>Task Content</label>
                                            <textarea class="ckeditor" name="taskContent" >{{ $taskData->taskContent }}</textarea>
                                        </div>
                                        <div class="form-group">
                                  ...
                                  <div class="col-lg-8">
                                    <div class="radio">
                                      <label>
                                        <input type="radio" name="tagStatus" id="optionsRadios1" value="1" <?php if($taskData->tagStatus==1) { echo 'checked'; }  ?>>
                                        Publish
                                      </label>
                                    </div>
                                    <div class="radio">
                                      <label>
                                      <input type="radio" name="tagStatus" id="optionsRadios1" value="0" <?php if($taskData->tagStatus==0) { echo 'checked'; }  ?>>
                                        Draft
                                      </label>
                                    </div>
                                  </div>
