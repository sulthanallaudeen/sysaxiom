...
<script src="public/admin/js/jquery.dataTables.min.js"></script> 
  	...
  	<div class="mainbar">
	    ...
	    <div class="page-head">
        <!-- Page heading -->
	      <h2 class="pull-left">Add Task 
          <!-- page meta -->
          <span class="page-meta" style="display:none">Something Goes Here</span>
        </h2>
        ...
        <div class="bread-crumb pull-right">
          ...
          <a href="#" class="bread-current">Task</a>
          <span class="divider">/</span> 
          <a href="#" class="bread-current">Add Task</a>
        </div>
