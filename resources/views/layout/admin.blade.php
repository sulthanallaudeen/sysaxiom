...
<head>
    ...
    <!-- MetisMenu CSS -->
	<link href="{{ asset('/').('public/admin/bower_components/metisMenu/dist/metisMenu.min.css') }}" type="text/css" rel="stylesheet"/>

    <!-- Timeline CSS -->
	<link href="{{ asset('/').('public/admin/dist/css/timeline.css') }}" type="text/css" rel="stylesheet"/>

    <!-- Custom CSS -->
	<link href="{{ asset('/').('public/admin/dist/css/sb-admin-2.css') }}" type="text/css" rel="stylesheet"/>

    <!-- Morris Charts CSS -->
	<link href="{{ asset('/').('public/admin/bower_components/morrisjs/morris.css') }}" type="text/css" rel="stylesheet"/>

    <!-- Custom Fonts -->
	<link href="{{ asset('/').('public/admin/bower_components/font-awesome/css/font-awesome.min.css') }}" type="text/css" rel="stylesheet"/>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    ...
                                    <ul class="nav nav-third-level">
                                        <li>
                                            <a href="{{ URL::to('/writeblog') }}">Write Blog</a>
                                        </li>
                                        <li>
                                            <a href="{{ URL::to('/listblog') }}">List / Edit Blog</a>
                                        </li>
                                    </ul>
                                    <!-- /.nav-third-level -->
                                </li>
                                <li>
                                    <a href="#">Tag<span class="fa arrow"></span></a>
                                    <ul class="nav nav-third-level">
                                        <li>
                                    <a href="{{ URL::to('/writetag') }}">Create Tag</a>
                                </li>
                                <li>
                                    <a href="{{ URL::to('/listtag') }}">List / Edit Tag </a>
                                </li>
                                    </ul>
                                    <!-- /.nav-third-level -->
                                </li>
