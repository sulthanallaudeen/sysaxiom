...
<script src="assets/js/jquery-ui-1.9.2.custom.min.js"></script> <!-- jQuery UI -->
...
<script src="assets/js/jquery.uniform.min.js"></script> <!-- jQuery Uniform -->
<script src="assets/js/bootstrap-switch.min.js"></script> <!-- Bootstrap Toggle -->
